...
=for stopwords invocant invocants lexicals unintuitive yada globals ro rw boolification rightwards scalarref smartmatch smartmatch-like
...
introduced in Perl 5.19.9. See L<perlsub>.
...
B<< Caveat: >> unlike Perl 5.19.9+'s built-in signatures, the following
B<< does not work >>:
